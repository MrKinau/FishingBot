...
public class ProtocolConstants {
    ...
    public static final int MINECRAFT_1_20_5_RC_3 = 1073742015;
    ...
    public static final List<Integer> SUPPORTED_VERSION_IDS = Arrays.asList(
            ...
            ProtocolConstants.MINECRAFT_1_20_5_RC_3
    );
    ...
    public static String getVersionString(int protocolId) {
        switch (protocolId) {
            ...
            case MINECRAFT_1_20_5_RC_3: return "1.20.5 Release Candidate 3";
    ...
    public static int getProtocolId(String versionString) {
        switch (versionString) {
            ...
            case "1.20.5 Release Candidate 3": return MINECRAFT_1_20_5_RC_3;
