...
public class DataComponentRegistry {
    ...
    public DataComponentRegistry() {
        ...
        addToRegistry(dataComponentRegistry.findKey("minecraft:entity_data"), NBTComponent::new);
        addToRegistry(dataComponentRegistry.findKey("minecraft:bucket_entity_data"), NBTComponent::new);
        addToRegistry(dataComponentRegistry.findKey("minecraft:block_entity_data"), NBTComponent::new);
